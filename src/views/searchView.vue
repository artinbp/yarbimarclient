<template>
  <div class="flex flex-row gap-4 px-2">
    ...
    <div class="container flex flex-wrap gap-4">
      <router-link v-for="(item, i) in products" :key="i" :to="'/product/'+item.id"
                   class="max-w-sm bg-white w-[350px] block border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
